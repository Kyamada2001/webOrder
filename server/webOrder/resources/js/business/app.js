...
Vue.component('weekly-holiday-select-component', require('./components/weekly-holiday-select.vue').default); //vuetify使わないかも
Vue.component('vuetailwind-holiday-select-component', require('./components/vuetailwind-holiday-select.vue').default);

const app = new Vue({
    el: '#app',
    vuetify: new Vuetify(),
    //VueTailwind: new VueTailwind(),
    components: {
