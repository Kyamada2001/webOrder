...
<div class="container mx-auto">
	<div class="flex flex-col items-center space-y-5">
		...
		<div class="flex flex-col items-center w-full space-y-3">
			<h2>アカウントをお持ちでない方</h2>
			<router-link class="grid justify-items-center rounded border-solid border border-red-500 hover:bg-red-50 text-red-500 w-3/4 md:w-1/2 h-11 pt-2 font-semibold" to="/member/select-register">会員登録</router-link>
		</div>
	</div>
</div>
</template>